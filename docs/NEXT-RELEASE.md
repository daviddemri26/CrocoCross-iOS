...
Current scope: Kenji and Japan earned unlocks, 2,600 m Weekly, per-world Endless records, flexible controls and falls, and 40 local achievements. The six added total-rotation milestones are 250, 500, 1,000, 2,500, 5,000 and 10,000.

The four associated boards use the v3 namespace; Japan is `endless.japan.route_1.score.v3`. The two Weekly boards start **2026-09-28 00:00 UTC** with seven-day duration and immediate restart; later occurrences are automatic.
