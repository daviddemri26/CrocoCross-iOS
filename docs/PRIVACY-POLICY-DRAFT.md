# CrocoCross Privacy Policy

Draft for the iPhone and iPad app, prepared September 12, 2026. Before publication, the owner must complete the fields below and confirm the support-message handling section. This document has not been published.

- Effective date: [OWNER TO SET]
- App operator: [OWNER TO CONFIRM LEGAL NAME]
- Privacy contact: [OWNER TO PROVIDE EMAIL OR CONTACT PAGE]
- Public policy URL: [OWNER TO PROVIDE HTTPS URL]
- Support page: [OWNER TO PROVIDE HTTPS URL]

## How CrocoCross works

CrocoCross runs on your device. It has no developer-operated game backend, advertising, advertising tracking or analytics SDK. We do not receive automatic gameplay or usage reports from the app. You do not need a separate CrocoCross account to play.
...
Deleting the app or signing out does not delete information already held by Game Center. There is no in-app control to erase that Apple-held information. Apple's retention and privacy practices are described in [Game Center & Privacy](https://www.apple.com/legal/privacy/data/en/game-center/); this policy does not promise a separate deletion period for Apple.

## Contacting support

If you contact us, we receive the information you choose to send so we can respond. Please include only what is needed to explain the issue, and never send passwords or verification codes.

[OWNER TO CONFIRM BEFORE PUBLICATION: support contact/provider, who handles requests, and how support messages are retained and deleted.]

For privacy questions, use the privacy contact listed above.
