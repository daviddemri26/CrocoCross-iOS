...
app_settings = {
    ...
    'ASSETCATALOG_COMPILER_APPICON_NAME': 'AppIcon', 'MARKETING_VERSION': '1.1.0',
    'CURRENT_PROJECT_VERSION': '18', 'LD_RUNPATH_SEARCH_PATHS': '$(inherited) @executable_path/Frameworks',
